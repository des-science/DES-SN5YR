...
Please check our [ReadTheDocs](https://des-sn-dr.readthedocs.io/en/main/) for all details on contents and ancillary data description.
...
**Please, for the full documentation refer to [readthedocs](https://des-sn-dr.readthedocs.io/en/main/).**
